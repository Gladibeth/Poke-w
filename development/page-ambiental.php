<?php get_header(); ?>
<div class="about-banner" style="background-image: url('<?php echo get_template_directory_uri();?>/assets/img/Ambiental/POKE_JUNIO-112.png');">
      ...
      <div class="main-ambiental">
        <div class="main-pokedots__box">
          <div class="main-general__description main-general__description--amb">
            <p>DURANTE ESTOS TRES AÑOS HEMOS TRABAJADO DÍA A DÍA PARA SER COHERENTES Y RESPONSABLES CON EL AMBIENTE:</p>
          </div>
        </div>
